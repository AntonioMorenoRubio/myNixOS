...
flake.nixosModules.fx506hm_Hardware = { config, lib, pkgs, modulesPath, ... }:

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/8dfd75f8-3334-43ac-866e-bca99001e777";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/0158-0397";
      fsType = "vfat";
